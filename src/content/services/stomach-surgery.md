---
title: "Stomach Surgery (Gastrectomy and benign gastric procedures)"
h1: "Stomach Surgery"
h1Html: "Stomach surgery, <em>cancer and benign disease</em>"
h1Secondary: "Gastrectomy · GIST resection · Ulcer surgery · Apollo Speciality Hospitals, Nellore"
slug: "stomach-surgery"
category: "upper-gi"
shortDescription: "Stomach surgery for cancer, GIST tumours, and complicated peptic ulcer disease by Dr. Dwarakanath Reddy at Apollo Nellore. Laparoscopic where appropriate."
procedureType: "Subtotal / Total Gastrectomy / GIST Resection"
typicalDuration: "3 to 6 hours"
hospitalStay: "7 to 10 days"
...
sections:
  ...
  - type: steps
    ...
    steps:
      - "Five or six small incisions are made in the upper abdomen under general anaesthesia"
      - "The abdomen is inflated with CO2 to create working space"
      - "The lesser and greater omentum are mobilised; lymph node stations are systematically cleared (D2 dissection for cancer)"
      - "The duodenum is divided distal to the pylorus"
      - "The lower two-thirds of the stomach are divided proximally with a stapler"
      - "Continuity is restored with a stapled or hand-sewn anastomosis (Billroth-II or Roux-en-Y)"
      - "Drains are placed; cuts are closed with absorbable sutures"
    outro: "Total operating time is 3 to 5 hours. The decision between distal, subtotal, and total gastrectomy depends on tumour location and proximal margin requirement."
  - type: timeline
    title: "Recovery timeline (after gastrectomy)"
    entries:
      - period: "Day of surgery"
        detail: "Inpatient ICU or HDU. NPO (nil by mouth) for the first 24 hours."
      - period: "Day 1 to 3"
        detail: "Walking by day one. Sips of clear fluid by day two or three after a contrast study confirms anastomotic integrity."
      - period: "Day 4 to 7"
        detail: "Soft, low-volume meals six times a day. Discharge typically around day 7 to 10."
      - period: "Week 2 to 4"
...
closingCta:
  prompt: "Have a gastric biopsy, CT scan, or endoscopy report? Share it on WhatsApp for a surgical opinion."
  label: "Send your scans on WhatsApp"
...
Stomach surgery at Apollo Speciality Hospitals, Nellore, by Dr. Dwarakanath Reddy Vembuluru.
