  ...
  { label: 'Home', href: '/' },
  {
    ...
    children: [
      { label: 'Surgical Gastroenterology', href: '/gi-services/surgical-gastroenterology', phase: '1' },
      {
        ...
        phase: '1',
        children: [
          { label: 'Gallbladder Surgery', href: '/gi-services/laparoscopic/gallbladder-surgery', phase: '1' },
          { label: 'Hernia Surgery', href: '/gi-services/laparoscopic/hernia-surgery', phase: '1' },
          { label: 'eTEP Hernia Surgery', href: '/gi-services/laparoscopic/etep-hernia', phase: '1' },
          { label: 'Appendix Surgery', href: '/gi-services/laparoscopic/appendix-surgery', phase: '2' },
          { label: 'Anti-reflux Surgery', href: '/gi-services/laparoscopic/anti-reflux-surgery', phase: '2' },
        ],
      },
      {
      ...
      },
      {
        ...
        phase: '1',
        children: [
          { label: 'Liver Tumor Surgery', href: '/gi-services/hpb/liver-tumor-surgery', phase: '1' },
          { label: 'Pancreatic Surgery', href: '/gi-services/hpb/pancreatic-surgery', phase: '1' },
          { label: 'Bile Duct Surgery', href: '/gi-services/hpb/bile-duct-surgery', phase: '2' },
          { label: 'Gallbladder Cancer Surgery', href: '/gi-services/hpb/gallbladder-cancer-surgery', phase: '2' },
        ],
      },
      {
        label: 'GI Oncology',
      ...
      },
      {
        ...
        phase: '1',
        children: [
          { label: 'Gastric Bypass', href: '/gi-services/bariatric/gastric-bypass', phase: '1' },
          { label: 'Sleeve Gastrectomy', href: '/gi-services/bariatric/sleeve-gastrectomy', phase: '1' },
          { label: 'Revision Bariatric Surgery', href: '/gi-services/bariatric/revision', phase: '2' },
        ],
      },
